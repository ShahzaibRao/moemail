        ...
        <div className="flex-1 overflow-auto p-2" onScroll={handleScroll}>
          {loading ? (
            ...
            <div className="text-center text-sm text-gray-500">
              No email addresses yet — create one!
            </div>
          )}
        </div>
      </div>
      ...
      <AlertDialog open={!!emailToDelete} onOpenChange={() => setEmailToDelete(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete the email {emailToDelete?.address} This action will also delete all messages in the mailbox and cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
